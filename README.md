...
<meta property="og:image" content="https://bitcoin.org/img/icons/opengraph.png?1625145073" />
...
<link rel="stylesheet" href="/css/main.css?1625145073">
<!--[if lt IE 8]><link rel="stylesheet" href="/css/ie.css"><script type="text/javascript" src="/js/ie.js"></script><![endif]-->
<!--[if IE 8]><link rel="stylesheet" href="/css/ie8.css"><![endif]-->


<script type="text/javascript" src="/js/base.js?1625145073"></script>
<script type="text/javascript" src="/js/main.js?1625145073"></script>
<script src="/js/jquery/jquery-1.11.2.min.js"></script>
<script src="/js/jquery/jquery-ui.min.js"></script>
<script src="/js/jquery/jquery.qrcode.min.js"></script>
<link rel="shortcut icon" href="/favicon.png?1625145073">
<link rel="apple-touch-icon-precomposed" href="/img/icons/logo_ios.png?1625145073"/>
<script>
    window.cookieconsent_options = {
        theme: 'light-floating'
    }
</script>
<script type="text/javascript" src="/js/cookieconsent/cookieconsent.js?1625145073"></script>
<script>
  ...
  <div class="donation-text">
    <div class="donation-text-container">
      <button onclick="closeDonationBanner()" class="donation-modal-close">
        <img src="/img/icons/ico_close.svg?1625145073" alt="Close">
      </button>
      <p>
...
<a class="logo" href="/en/"><img src="/img/icons/logotop.svg?1625145073" alt="Bitcoin"></a>
...
<div class="mainoverview">
  <div class="container">
    ...
    <a href="/en/bitcoin-for-individuals" class="maincard">
      <img class="maincard-img" src="/img/icons/ico_individuals.svg?1625145073" alt="Icon">
      <div>
    ...
    <a href="/en/bitcoin-for-businesses" class="maincard">
      <img class="maincard-img" src="/img/icons/ico_business.svg?1625145073" alt="Icon">
      <div>
    ...
    <a href="https://developer.bitcoin.org/" class="maincard">
      <img class="maincard-img" src="/img/icons/ico_developers.svg?1625145073" alt="Icon">
      <div>
  ...
  <a class="btn-down" href="#maindesc-title">
    <img src="/img/icons/ico_arrow_down.svg?1625145073" alt="Link">
  </a>
</div>
<div class="maindesc">
  <div class="container">
      ...
      <div>
        ...
        <ul class="mainlist">
            ...
            <li class="mainlist-item">
              <img src="/img/icons/main_ico_instant.svg?1625145073" alt="Icon">
              <p>Fast peer-to-peer transactions</p>
            </li>
          
          
            <li class="mainlist-item">
              <img src="/img/icons/main_ico_worldwide.svg?1625145073" alt="Icon">
              <p>Worldwide payments</p>
            </li>
          
          
            <li class="mainlist-item">
              <img src="/img/icons/main_ico_lowfee.svg?1625145073" alt="Icon">
              <p>Low processing fees</p>
            </li>
          
        </ul>
      </div>
      <img class="maindesc-img" src="/img/home/bitcoin-img.svg?1625145073" alt="Bitcoin image">
    </div>
    <div class="btn-container">
...
<a class="logo-footer" href="/en/">
  <img src="/img/icons/logo-footer.svg?1625145073" alt="Bitcoin">
</a> 
...
<div class="footersponsor">
  <!--<div><span>A community website sponsored by</span> <a href="https://bitcoinfoundation.org/"><img src="/img/brand/bitcoinfoundation.png?1625145073" alt="Bitcoin Foundation"></a></div>-->
</div>
...
<div class="footer-bottom">
  <div class="container">
    <div class="row footer-bottom-row">
      <div class="footerlicense">© Bitcoin Project 2009-2021 Released under the <a href="http://opensource.org/licenses/mit-license.php" target="_blank">MIT license</a></div>
